using Cubo.KartSolution.Shared.Events;
using System.Collections.Generic;
using System.Linq;
using System.Text.RegularExpressions;

namespace Cubo.KartSolution.Shared.Validation
{
    public static class AssertionConcern
    {
        ...
        public static DomainNotification AssertNotNone(string stringValue, string message)
        {
            return (stringValue == "None") ?
                new DomainNotification("AssertArgumentNotNone", message) : null;
        }
